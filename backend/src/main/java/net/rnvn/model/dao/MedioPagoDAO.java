...
public class MedioPagoDAO extends PolizasDAO {
    ...
    private static final String SQL_ADD_MEDIO_PAGO = QueryGen.genInsertInto(
            TABLE_NAME,
            new String[] { "id", "id_cliente", "numero_tarjeta", "nombre_titular", "fecha_vencimiento", "cvv" });
    private static final String SQL_GET_MEDIO_PAGO = QueryGen.genSelectString(
            TABLE_NAME,
            new String[] { "id_cliente", "numero_tarjeta", "nombre_titular", "fecha_vencimiento", "cvv" },
            new String[] { "id = ?" });
    private static final String SQL_UPDATE_MEDIO_PAGO = QueryGen.genUpdateString(
            TABLE_NAME,
            new String[] { "id_cliente", "numero_tarjeta", "nombre_titular", "fecha_vencimiento", "cvv" },
            new String[] { "id = ?" });
    private static final String SQL_DELETE_MEDIO_PAGO = QueryGen.genDeleteString(
            TABLE_NAME,
            new String[] { "id = ?" });
